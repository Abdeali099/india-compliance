...
def _create_suppliers():
    ...
    supplier_data = [
        ...
        ("Metro Office Products", "SEZ", "06AAACC1206D2ZJ", "Company"),
        (
        ...
        ("Prime Electronics India", "UIN Holders", "10AAACC1206D3ZT", "Company"),
        (
            "Omega Trading House",
            "Registered Composition",
            "20AAACC1206D1ZU",
        ...
        ("Alpha Tech Distributors", "Tax Deductor", "19AAACC1206D2ZC", "Company"),
        ("Beta Business Solutions", "Registered Regular", "22AAACC1206D1ZQ", "Company"),
        ("Gamma Office Mart", "Unregistered", "", "Individual"),
        ("Delta Electronics Supply", "Tax Collector", "07AAACC1206D2ZH", "Company"),
        (
            "Epsilon Stationery",
            "Registered Composition",
            "37AAACI1681G2ZN",
        ...
        ("Eta Business Products", "Unregistered", "", "Individual"),
        ("Theta Office Supplies", "Registered Regular", "12AAACI1681G1Z0", "Company"),
        ("Iota Electronics Hub", "Deemed Export", "18AAACI1681G1ZO", "Company"),
        (
        ...
        ("Lambda Tech Supplies", "Registered Regular", "04AAACI1681G1ZX", "Company"),
        ("Mu Office Equipment", "Unregistered", "", "Individual"),
        ("Nu Electronics Depot", "Overseas", "", "Company"),
        ("Xi Business Center", "Registered Regular", "22AAACI1681G1ZZ", "Company"),
        (
        ...
        ("Pi Tech Solutions", "Registered Regular", "07AAACI1681G1ZR", "Company"),
        ("Rho Office Products", "Unregistered", "", "Individual"),
    ]

    suppliers = []
    for name, gst_category, gstin, supplier_type in supplier_data:
        supplier = {
            "name": name,
            "supplier_name": name,
